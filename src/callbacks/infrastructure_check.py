...
from src.query import results_tiled_dataloader
from src.utils.prefect import check_prefect_ready
...
def check_infra_state(n_intervals):
    ...
    tiled_results_ready = results_tiled_dataloader.check_dataloader_ready()
    infra_state["tiled_results_ready"] = tiled_results_ready

    tiled_labels_ready = labels_tiled_dataloader.check_dataloader_ready()
